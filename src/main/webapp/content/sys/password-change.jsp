        ...
        <div class="span12">
          ...
          <div class="portlet box blue">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"><i class="icon-edit"></i>密码修改</div>
              ...
              <div class="portlet-body form">
                ...
                <form action="" class="form-horizontal" id="submit_form">
                  ...
                  <div class="control-group">
                    ...
                    <label class="control-label">修改前密码</label>

                    <div class="controls">

                      <input type="password" id="oldPwd" class="m-wrap span6" name="oldPwd">
                  ...
                  <div class="control-group">
                    ...
                    <label class="control-label">修改后密码</label>

                    <div class="controls">

                      <input type="password" id="newPwd" class="m-wrap span6" name="newPwd">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="password" id="cfmPwd" class="m-wrap span6" name="cfmPwd">
                  ...
                  <div class="form-actions">
                    ...
                    <button type="reset" class="btn" id="cancelBtn">重置</button>
...
<script src="${ctx}/s/app/sys/password-change.js"></script>
