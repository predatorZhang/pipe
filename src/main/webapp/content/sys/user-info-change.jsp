        ...
        <div class="span12">
          ...
          <div class="portlet box blue">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"><i class="icon-edit"></i>个人信息修改</div>
                ...
                <form action="" class="form-horizontal" id="submit_form">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" id="tel" class="m-wrap span6" name="tel" value="<%= ((UserInfo)session.getAttribute(StringUtils.SYS_USER)).getTel() %>">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" id="address" class="m-wrap span6" name="address" value="<%=((UserInfo)session.getAttribute(StringUtils.SYS_USER)).getAddress()%>">
...
<script src="${ctx}/s/app/sys/user-info-change.js"></script>
