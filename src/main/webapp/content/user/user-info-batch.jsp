...
<div id="earthDiv" style="width: 0px;height: 0px;"></div>
        ...
        <div class="span12">
          ...
          <div class="portlet box blue">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"><i class="icon-edit"></i>用户批量导入</div>
              ...
              <div class="portlet-body form">
                ...
                <form class="form-horizontal" method="post"
                  ...
                  <div class="control-group">
                    ...
                    <label class="control-label">EXCEL文件<span class="required">*</span></label>
                        ...
                        <div class="input-append">
                          ...
                          <div class="uneditable-input">
                            ...
                            <span class="fileupload-preview"></span>
                                                            ...
                                                            <span class="fileupload-new green">选择</span>

                                                            <span class="fileupload-exists purple">变更</span>

                                                            <input type="file" class="default" name="shpFile" id="dbfFile"/>

                                                            </span>

                          <%--<a href="#" class="btn fileupload-exists red" data-dismiss="fileupload">删除</a>--%>

                        </div>

                        <span class="validate-inline" for="dbfFile"></span>
...
<script type="text/javascript" src="${ctx}/s/media/js/jquery.form.js"></script>
...
<script src="${ctx}/s/gis/gis.js"></script>

<script src="${ctx}/s/app/user/user-info-batch.js"></script>
