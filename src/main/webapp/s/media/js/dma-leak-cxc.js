var DmaLeakContrast = function () {
    ...
    return {
        ...
        initDmaLeakContrast: function () {
                ...
                $.ajax( {
                    ...
                    success: function(data) {
                        ...
                        for(var i=0 ;i<len;i++){
                            ...
                            dataOut[i] = data.aaData[i].saleWater;
                            dataCha[i] = data.aaData[i].saleDiffWater;
                        }
            ...
            oTable = $('#table_dma_leak_cxc').dataTable({
                "aLengthMenu": [
                    [5, 15, 20, -1],
                ...
                "sAjaxSource": $('#context').val()+"/dma/dma-cxc.do",
            ...
            jQuery('#table_dma_leak_cxc_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
            jQuery('#table_dma_leak_cxc_wrapper .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
            jQuery('#table_dma_leak_cxc_wrapper .dataTables_length select').select2({
